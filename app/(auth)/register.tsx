      ...
      >
        ...
        <Animated.View style={[styles.header, { opacity: fadeAnim, transform: [{ translateY: slideAnim }] }]}>
          <TouchableOpacity style={styles.backButton} onPress={() => router.back()} hitSlop={{ top: 10, bottom: 10, left: 10, right: 10 }}>
            <ArrowLeft color="#ffd700" size={22} />
          </TouchableOpacity>
        ...
        <Animated.View style={[styles.form, { opacity: formFadeAnim, transform: [{ translateY: formSlideAnim }] }]}>
          ...
          <Text style={styles.formSubheading}>Join the community of history explorers.</Text>

          {/* Username Input */}
          <View style={[styles.inputWrapper, focusedField === 'username' && styles.inputWrapperFocused]}>
            <UserIcon color={focusedField === 'username' ? '#ffd700' : '#444'} size={18} style={styles.inputIcon} />
            <TextInput
              style={styles.input}
